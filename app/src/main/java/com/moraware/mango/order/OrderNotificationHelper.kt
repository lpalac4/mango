...
/**
 * Helper class for showing and canceling order helper
 * notifications.
 *
 *
...
object OrderNotificationHelper {
     ...
     */
    private val NOTIFICATION_TAG = "OrderHelper"
     ...
     * presentation of order helper notifications. Make
     * sure to follow the
     * [
 * Notification design guidelines](https://developer.android.com/design/patterns/notifications.html) when doing so.
    ...
    fun notify(context: Context,
        ...
        val picture = BitmapFactory.decodeResource(res, R.drawable.ic_menu_profile)


        val title = res.getString(
                R.string.order_helper_notification_title_template, exampleString)
        val text = res.getString(
                R.string.order_helper_notification_placeholder_text_template, exampleString)
